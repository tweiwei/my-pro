#include "stdio.h"
int lrsc_ins(int* old, int cmp, int new);//声明lrsc_ins函数
int amoswap_ins(int* old, int new);//声明amoswap_ins函数
int amoadd_ins(int* old, int new);//声明amoadd_ins函数
int amoand_ins(int* old, int new);//声明amoand_ins函数
int amoor_ins(int* old, int new);//声明amoor_ins函数
int amoxor_ins(int* old, int new);//声明amoxor_ins函数
int amomax_ins(int* old, int new);//声明amomax_ins函数
int amomaxu_ins(int* old, int new);//声明amomaxu_ins函数
int amomin_ins(int* old, int new);//声明amomin_ins函数
int amominu_ins(int* old, int new);//声明amominu_ins函数
int main()
{
    int result = 0;
    int val = 1;
    ...
    // printf("This is locked:%d :%d :%d\n", Lock(&lock), Lock(&lock), UnLock(&lock));
